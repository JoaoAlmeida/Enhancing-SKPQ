...
bars2 = data.frame(imp_ra, imp_a, imp_f)
...
legend(3.1, 10, inset=.1, bty = "n",
       c("RQ@R","SKPQ@R","SkPQ@F"), 
       fill=c("darkblue", "darkred", "darkgreen"), horiz=FALSE, cex=0.8)
